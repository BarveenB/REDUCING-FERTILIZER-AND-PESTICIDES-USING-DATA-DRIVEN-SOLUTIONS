...
class Config:
    ...
    model_path = "shufflenet_model.pth"
    input_size = 224
    ...
    if crop_model is None or label_encoders is None:
        ...
        with st.form("crop_form"):
            ...
            with col1:
                ...
                season = st.selectbox('Season', options=label_encoders['season'].classes_)  # Added season input
        ...
        if submit:
            try:
                ...
                season_enc = label_encoders['season'].transform([season])[0]  # Encode season
                
                input_data = [[
                    district_enc, soil_enc, season_enc,  # Now includes season
                ...
                try:
                    ...
                    tts.save('rec.mp3')
                    st.audio('rec.mp3')
                    os.remove('rec.mp3')  # Clean up audio file
                except Exception as e:
            ...
            try:
                ...
                if st.checkbox("Enable audio feedback", True):
                    ...
                    try:
                        ...
                        tts.save('pest.mp3')
                        st.audio('pest.mp3')
                        os.remove('pest.mp3')  # Clean up audio file
                    except Exception as e:
                        st.warning(f"Audio generation failed: {str(e)}")
